<label class="content-expand-label">
	<input type="checkbox" class="content-expand-check">
	<div class="item ripple">
		<div class="col-1">
			<div class="circle-mask">
				<img src="data/news01.jpg" title="Nadpis novinky">
			</div>
			<div class="news-info">
...
<label class="content-expand-label">
	...
	<div class="item ripple">
		<div class="col-1">
			<div class="circle-mask">
				<img src="data/news02.jpg" title="Nadpis novinky">
			</div>
			<div class="news-info">
				<div class="release-date">7.2.2016</div>
				<div class="author"><a href="page-profile.php">MartinF</a></div>
...
<label class="content-expand-label">
	...
	<div class="item ripple">
		<div class="col-1">
			<div class="circle-mask">
				<img src="data/news03.jpg" title="Nadpis novinky">
			</div>
			<div class="news-info">
...
<label class="content-expand-label">
	...
	<div class="item ripple">
		<div class="col-1">
			<div class="circle-mask">
				<img src="data/news04.jpg" title="Nadpis novinky">
			</div>
			<div class="news-info">
